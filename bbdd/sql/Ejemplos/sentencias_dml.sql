...
INSERT INTO tb_cliente (nombre, email, fecha_alta, fecha_nac, creado_en)
VALUES (
  'Luis Gómez',
...
INSERT INTO tb_cliente (nombre, email, fecha_nac)
VALUES (
  'María Ruiz',
...
INSERT INTO tb_cliente (nombre, email, creado_en)
VALUES (
  'Carlos Ortega',
...
-- Ver lo insertado
SELECT * FROM tb_cliente ORDER BY id;
...
-- Comprobar cambios
SELECT id, nombre, email, fecha_alta FROM tb_cliente ORDER BY id;
